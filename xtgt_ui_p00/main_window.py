...
class MainWindow(QMainWindow):
    ...
    def __init__(self, ui_path: str):
        ...
        self.lidar_log_dir = Path.home() / "temp" / "dis_logs"
    ...
    def connect_signals_and_init(self):
        ...
        waypoint_btn.setEnabled(True)
        rviz_btn.setEnabled(True)
    ...
    def time_sync_finished(self, robot: str, ok: bool, out: str, err: str):
        ...
        # 시간 동기화 timeout/error가 떠도 UI는 Sync Done으로 처리
